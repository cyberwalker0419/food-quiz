...
> 30–45 道动态自适应问题，揭开你 8 维味觉偏好；雷达图 + 味觉特征长评价 + 推荐菜 + 国风分享卡。
...
- **动态 30–45 题**：基础 30 题必答；检测到「同主题不一致 / 同维强弱波动」矛盾时追加追问，最多 45 题。
...
| 常量 | 值 | 含义 |
|:--|:--|:--|
| `MIN_QUESTIONS` | 30 | 基础题必答（shouldStop 必答下限） |
| `LATE_START` | 25 | late 评分 + 追问启动门槛（与必答下限解耦） |
